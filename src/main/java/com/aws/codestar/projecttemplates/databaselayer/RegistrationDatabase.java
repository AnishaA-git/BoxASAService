...
public class RegistrationDatabase {
	...
	public boolean register(String firstusername, String lastusername, String password) {
		boolean flagForRegistration = false;
		Connection connectionObject = null;
		PreparedStatement statementObject = null;
		ResultSet resultSetObject = null;

		String query = "INSERT INTO user(firstusername,lastusername,password) VALUES (?,?,?)";
